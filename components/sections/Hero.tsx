...
export function Hero() {
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
            ...
            <div className="absolute top-1/4 -left-20 w-80 h-80 bg-indigo-600/5 rounded-full blur-[120px] pointer-events-none opacity-50" />
            <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-slate-600/5 rounded-full blur-[120px] pointer-events-none opacity-50" />
            ...
            <div className="max-w-7xl mx-auto px-4 w-full text-center z-10">
                ...
                >
                    <motion.div
                        ...
                        className="mb-8 p-1 rounded-full bg-[#1e293b] border border-slate-700 shadow-sm"
                    >
                        <span className="px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#94a3b8]">
                            Open to new opportunities
                        </span>
                    </motion.div>

                    <h1 className="text-5xl md:text-8xl font-black mb-6 tracking-tight text-[#f1f5f9]">
                    ...
                    <p className="text-xl md:text-2xl text-gray-400 max-w-2xl mx-auto font-medium mb-12 leading-relaxed">
                        Software Engineer <span className="text-indigo-500">|</span> Building Scalable SaaS Experiences
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="px-8 py-4 rounded-full bg-indigo-600 text-white font-bold flex items-center gap-2 group transition-all hover:bg-indigo-500 hover:shadow-indigo-500/20 hover:shadow-lg border border-indigo-400/20"
                        >
                            View My Work
